<header>
    <div class="wrap">
        <div class="header-items">
            <a <? if( $pg[1] != 'home' and $pg[1] != 'minha-conta'){?>class="logohome" href="/"<? }else{?>class="logotipo" href="/home"<?}?> title="Vesna">
        ...
        $empe = $banco->lista('parceiros', "id = '".$_COOKIE['cliente_empresa']."'");
            if( $pg[1] == 'home' or $pg[1] == 'minha-conta'){?>
            ...
            <div class="header-icons">
                    <div class="minha-conta">
                        <p style="float:left; text-align:right; margin-top:15px">
                            <strong style="font: 600 17px/17px 'Nunito'"><?
                             echo $empe[0]['nome'];
                            ?></strong><br />
                            <span style="font: 300 14px/14px 'Nunito'; color:#666"> <?=$_COOKIE['cliente_nome']?></span> <br />
                            
                            <a href="/" style="text-decoration:none; background: rgba(255,255,255,0.6); border-radius:30px; padding:5px 10px; display:inline-block; font-size:12px">
