...
# Database: vesna
# Generation Time: 2023-05-03 07:53:27 +0000
# ************************************************************
...
VALUES
	...
	(2,'Sim','Marcopolo','324','+','','+','','+','','+','','+','','+','','ae5870e3202639069d1538767f000d01','marcopolo');
...
INSERT INTO `logins` (`id`, `empresa`, `user`, `senha`, `token`, `clean_url`, `nome`, `email`)
VALUES
	(1,'2','teste','qweasd','44eec0812e0ed0202d40ad10336e1d6e','joao-silva','João Silva','contato@vesna.com.br'),
	(2,'2','trump','qweasd','bb3b7bb7de69259e35e622f307f4b41b','alfredo','alfredo','alfredo@agtp'),
	(3,'2','123123','1231','d50d1514e0f9faed78157fe0dcc7dd05','12312','12312','312312');
...
VALUES
	(1,'Vesna','contato@vesna.com.br','','','','','',NULL,NULL,NULL,NULL,',empresas,relatorios,logins',NULL,'');
