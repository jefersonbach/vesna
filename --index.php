...
include('build/painel/includes/class.banco.php');	
...
<head>
    <?php
        include('build/includes/html/metatags.php');
        include('build/includes/html/css.php');
    ?>
</head>
<body>
    <?php
        // Pages
	 	include('build/core/pages.php');
	
        // Scripts
        include('build/includes/html/scripts.php');
    ?>
</body>
</html>