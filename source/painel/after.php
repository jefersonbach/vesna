			...
			<tr style="border:4px solid #fff; background:#eee; padding:10px 0 !important; ">
				...
				?>
					<a href="cad_<?=$p?>.php?editar=<?=$lisImg['id']?>" class="thumbnail">
                    	<img src="<?=$resulSeo->crop('/painel/arquivos/'.$p.'/'.$prodsImg[0]['img'],'150','113','far', true)?>" style="float:right; margin:0px 0 20px 20px" alt="<?=$lisImg['legenda']?>" class="img-rounded img-polaroid" />
                    </a>
